// The resource to display policies
export const KYVERNO_RESOURCE_NAME_ANNOTATION = 'kyverno.io/resource-name';

// The kind of the resource to display policies
export const KYVERNO_KIND_ANNOTATION = 'kyverno.io/kind';
