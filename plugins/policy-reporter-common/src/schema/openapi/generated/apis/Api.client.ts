...
export class DefaultApiClient {
  ...
  /**
   * List of all Categories with namespace scoped results
   * Get categories
  ...
  /**
   * List of all Sources with namespace scoped results
   * Get sources
   * @param environment - The environment entity reference (URL encoded)
   */
  public async getSources(
    ...
    const uriTemplate = `/v1/namespaced-resources/sources{?environment}`;
