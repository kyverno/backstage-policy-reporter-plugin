  ...
  paths: {
    ...
    '/v1/namespaced-resources/categories': {
      get: {
        ...
        description: 'List of all Categories with namespace scoped results',
    ...
    '/v1/namespaces': {
      get: {
        ...
        description: 'Retrieves a list of namespaces from the policies',
